...
public:
    ...
    uint32_t CalculateKeyboardAvoidHeight(uint32_t keyboardHeight);
    ...
    void SetWindowModal(bool isModal);

    int32_t GetZLevel() const
    {
        return zLevel_;
    }
...
private:
    ...
    void SetWindowZLevel(int32_t zLevel);
    void SetParentId(uint32_t parentId);
    void SetRequestRect(std::shared_ptr<WindowOption> option);
...
private:
    ...
    int32_t lastNotifiedKeyboardHeight_ = -1;
    int32_t originWindowY_ = 0;
