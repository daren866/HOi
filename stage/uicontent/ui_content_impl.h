...
public:
    ...
    {
        DestroyCallback();
        Ace::Platform::UIContent::RemoveUIContent(uiContentInstanceId_);
    }
    ...
    virtual void SetIgnoreViewSafeArea(bool ignoreViewSafeArea) override;
...
private:
    ...
    int32_t uiContentInstanceId_ = -1;
